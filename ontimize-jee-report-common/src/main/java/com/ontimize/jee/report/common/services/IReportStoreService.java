...
public interface IReportStoreService {
     ...
     * @param reportSource the report sources in zip format
     ...
     * @param otherType        the other type if ReportOutputType other is selected
     ...
     *
     * @param reportId         the report id
     * @param serviceName      the service name (must be an IReportAdapter)
